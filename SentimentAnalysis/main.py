...
def sentiment_analysis(filename):
    ...
    try:
        # 读取数据集
        dataset = read_csv(filename,encoding='ISO-8859-1')
        ...
        dataset.to_csv('D:/人力资源管理课程/3-上-人力资源统计学/报告/DataAnalysis/SentimentAnalysis/output/result.csv',encoding='ISO-8859-1')
